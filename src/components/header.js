...
//    this.props.fetchCustomVars()
  ...
  renderToggleASNAP() {
    if(this.props.roles.includes('admin') || this.props.roles.includes('event_manager') || this.props.roles.includes('event_logger')) {
      return (
